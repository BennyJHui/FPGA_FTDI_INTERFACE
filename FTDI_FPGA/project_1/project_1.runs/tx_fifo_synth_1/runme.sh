...
HD_PWD='C:/Users/HUB4RT/Desktop/FTDI_FPGA/project_1/project_1.runs/tx_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_fifo.tcl
