...
#
# Script generated by Vivado on Thu Dec 11 18:10:23 +0100 2025
...
#
# Usage        : tx_fifo.sh
#                tx_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tx_fifo.sh [-reset_run]
#                tx_fifo.sh [-reset_log]
#                tx_fifo.sh [-help]
#
...
# script info
echo -e "tx_fifo.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tx_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tx_fifo xil_defaultlib.tx_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tx_fifo -key {Behavioral:sim_1:Functional:tx_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tx_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tx_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tx_fifo.sh [-help]\n\
Usage: tx_fifo.sh [-step]\n\
Usage: tx_fifo.sh [-lib_map_path]\n\
Usage: tx_fifo.sh [-reset_run]\n\
Usage: tx_fifo.sh [-reset_log]\n\
Usage: tx_fifo.sh [-keep_index]\n\
Usage: tx_fifo.sh [-noclean_files]\n\n\
